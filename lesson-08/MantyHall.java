...
В качестве игры использовал парадокс Монти Холла. На выбор предлагается открыть одну из трех дверей. За одной из них скрывается приз. После того, как мы делаем выбор - ведущий открывает любую пустую дверь и предлагает изменить свой выбор.

Реализация элементарна - 3 кнопки и диалоговые сообщения от ведущего.
Попытался отделить графическую составляющую, от самой логики, но это оказалось не очень просто. 
Основная логика находится в этом классе, с ней проблем не возникло
*/
